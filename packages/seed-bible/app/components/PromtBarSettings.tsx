  ...
  return (
    <div className="aiSettings-container boundElements">
      <div className="routerOptions">
        ...
        <div className="softText">{t("promtBarSettings")}</div>
      ...
      <div className="routerTitle blackText">
        ...
        <div className="blackText">{t("wordTool")}</div>
      </div>

      <div className="mediumText">{t("settingsForWordToolAndMindmap")}</div>
      ...
      <div className="ai-chat">
        ...
        >
          ...
          <div className="blackText">{t("mindmap")}</div>
