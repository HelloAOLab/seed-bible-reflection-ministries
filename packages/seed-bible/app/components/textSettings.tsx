  ...
  return (
    <div className="textSettings-sidebar">
      <div className="routerOptions">
        ...
        <div className="softText">{t("text")}</div>
      </div>
      ...
      <div className="mediumText">{t("settingsForTextOnPage")}</div>
      ...
      {[
        ...
        <div key={section} className="flexColumn-10">
          ...
          <p style={{ margin: "0" }}>{t("marginVertical")}</p>
          <Input
            ...
            placeholder="10"
          />
          <p style={{ margin: "0" }}>{t("marginHorizontal")}</p>
          <Input
