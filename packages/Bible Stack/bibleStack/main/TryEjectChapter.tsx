    ...
    thisBot.CheckChapterAvailabilityInBook({bookData: thisBot.vars.lastInteractedStackBookData, chapterNumber}))
{
    ...
    await thisBot.EjectChapter({bookData: thisBot.vars.lastInteractedStackBookData, chapterNumber});
}
else
{
    const bookData = thisBot.vars.lastInteractedStackSectionData ? thisBot.vars.lastInteractedStackSectionData.childrenData.flat().find((currBookData) => {return currBookData.pieceInfo.commonName === bookName}) : null
