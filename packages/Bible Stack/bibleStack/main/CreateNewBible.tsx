...
if(jarvis && !position  && bibleType === BibleVizUtils.Data.tags.BibleType.Default)
{
...
if(displayJarvisSpawnPieceAnimation) await jarvis.SpawnPieceEnd({scales: new Vector3(4.5, 4.5, 4.5)})
