...
stacksUpdates = thisBot.vars.stackBiblesData
  ...
  .concat(
    thisBot.vars.stackTestamentsData
      .filter((testamentData: StackTestamentData) => {
        return !testamentData.getParentId("stackBibleId");
      })
      .map((testamentData: StackTestamentData) => {
    ...
    thisBot.vars.stackSectionsData
      .filter((sectionData: StackSectionData) => {
        return !sectionData.getParentId("stackTestamentId");
      })
      .map((sectionData: StackSectionData) => {
    ...
    thisBot.vars.stackSectionBooksData
      .filter((sectionBookData: StackSectionBookData) => {
        return !sectionBookData.getParentId("stackTestamentId");
      })
      .map((sectionBookData: StackSectionBookData) => {
    ...
    thisBot.vars.stackBooksData
      .filter((bookData: StackBookData) => {
        return !bookData.getParentId("stackSectionId");
      })
      .map((bookData: StackBookData) => {
        return thisBot.UpdateBookStack({
          bookData,
          speedMultiplier,
          isInstantaneous,
