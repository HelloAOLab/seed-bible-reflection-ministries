...
const infoLabelDesiredPosition          = new Vector3(infoLabelDesiredOffset.x, infoLabelDesiredOffset.y + (infoLabelDesiredScales.y / infoLabelTransformerDesiredScales.y / 2), infoLabelDesiredOffset.z);
const infoLabelTailDesiredPosition      = new Vector3(infoLabelTailDesiredOffset.x, infoLabelTailDesiredOffset.y - (0.3 / infoLabelTransformerDesiredScales.y / 2), infoLabelTailDesiredOffset.z)
const infoLabelTailDesiredRotationZ     = 0;
const infoLabelTailDesiredScales        = new Vector3(0.3 / infoLabelTransformerDesiredScales.x, 0.3 / infoLabelTransformerDesiredScales.y, 0.3 / infoLabelTransformerDesiredScales.z);
let infoLabelTransformerMod, infoLabelMod, infoLabelTailMod;

os.focusOn({x: (thisBot.masks[dimension + "X"] ?? thisBot.tags[dimension + "X"]), y: (thisBot.masks[dimension + "Y"] ?? thisBot.tags[dimension + "Y"])}, {
