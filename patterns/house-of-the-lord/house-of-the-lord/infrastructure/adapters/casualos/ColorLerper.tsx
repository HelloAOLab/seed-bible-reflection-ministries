...
import type { ColorLerpablePieceBot } from "../../models/casualos";
import {
  ClampRGBColor,
  HexToRgb,
  RgbToHex,
...
export class ColorLerper {
  ...
  stop(bot: ColorLerpablePieceBot, tag: LerpableTags) {
