...
// const collisionType = bibleData?.bibleType === BibleVizUtils.Data.tags.BibleTypes.PlatformerGame ? CollisionType.Collision : null

tryHideNotification(testament);
shout("OnStackTestamentSelected", {
  isFromPlatformerGame:
    bibleData && bibleData.bibleType === BibleTypes.PlatformerGame,
});
